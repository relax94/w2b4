...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            appcom_1.AppComponent,
            auth_2.AuthComponent,
            home_1.HomeComponent,
            charts_1.NetworkMonitorComponent,
            map_1.NetworkMapComponent
        ],
        imports: [
            ...
            store_1.StoreModule.provideStore({ auth: auth_1.auth, networkReducer: network_1.networkReducer }),
            ng2_charts_1.ChartsModule, core_2.AgmCoreModule.forRoot({
        ...
        providers: [
            ...
            network_actions_1.NetworkActions,
            api_1.API_PROVIDERS
        ]
    })
], AppModule);
